...
int board_late_init(void)
{
	...
	if(!cpu_is_mx6q()) {
		...
		pscl->i2c_mode = MX6DL_PAD_GPIO_3__I2C3_SCL | PC;
		pscl->gpio_mode = MX6DL_PAD_GPIO_3__GPIO_1_3 | PC;
		psda->i2c_mode = MX6DL_PAD_GPIO_6__I2C3_SDA | PC;
		psda->gpio_mode = MX6DL_PAD_GPIO_6__GPIO_1_6 | PC;
	}
