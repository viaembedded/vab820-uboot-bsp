...
int arch_cpu_init(void)
{
	...
	// steven
	nData = BM_ANADIG_PFD_528_PFD3_CLKGATE |
		BM_ANADIG_PFD_528_PFD1_CLKGATE |
		BM_ANADIG_PFD_528_PFD0_CLKGATE;
	if (cpu_is_mx6q()) { nData |= BM_ANADIG_PFD_528_PFD2_CLKGATE; }
	writel(nData,
...
// steven: default get_mmc_env_devno()
__attribute__((weak)) int get_mmc_env_devno(void)
{
